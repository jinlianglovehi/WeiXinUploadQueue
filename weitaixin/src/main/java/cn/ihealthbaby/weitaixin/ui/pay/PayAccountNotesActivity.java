...
import cn.ihealthbaby.weitaixin.adapter.PayAccountNotesAdapter;
import cn.ihealthbaby.weitaixin.adapter.PayMimeAddressAdapter;
import cn.ihealthbaby.weitaixin.base.BaseActivity;

public class PayAccountNotesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_account_notes);

        ButterKnife.bind(this);

        title_text.setText("账户记录");

        pullData();
    }

    private void pullData() {
        PayAccountNotesAdapter adapter = new PayAccountNotesAdapter(getApplicationContext(), null);
