...
public class PayAccountNotesAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<AdviceItem> datas;
    private LayoutInflater mInflater;

    public PayAccountNotesAdapter(Context context, ArrayList<AdviceItem> datas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_pay_account_notes, null);
...
//        AdviceItem adviceItem = this.datas.get(position);
    ...
    static class ViewHolder {
        @Bind(R.id.tvAccountNotesName) TextView tvAccountNotesName;
        @Bind(R.id.tvAccountNotesTime) TextView tvAccountNotesTime;
        @Bind(R.id.tvAccountNotesPrice) TextView tvAccountNotesPrice;
